...
#define LED_6_out  GPIO_ReadInputDataBit( LED_6_GPIO_PORT, LED_6_GPIO_PIN);
#define LED_7_out  GPIO_ReadInputDataBit( LED_7_GPIO_PORT, LED_7_GPIO_PIN);


void Find_Nun_Init_B(void);
void Find_Nun_Init_C(void);
